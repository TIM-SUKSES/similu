...
<div class="box">
            <div class="box-header">
                ...
                <a href="<?php echo site_url('admin/DataUser/tambah') ?>" class="btn bg-red"><i class="fa fa-plus-circle"> Tambah Data User </i></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                    <?php $id_masyarakat = 1; foreach($tabel as $table) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('admin/DataUser/edit/'. $table->id_masyarakat); ?>" 
                                class="btn btn-sm btn-info"><i class="fa fa-pencil-square-o"></i>Ubah</a>
                                <a href="<?php echo site_url('admin/DataUser/hapus/'. $table->id_masyarakat); ?>" 
