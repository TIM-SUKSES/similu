<section class="content">
  ...
  <div class="box">
    <div class="box-header">
      ...
      <a href="<?php echo site_url('admin/DataUser') ?>" class="btn bg-green"><i class="fa fa-arrow-circle-left"> Kembali </i></a>
    </div>
    <!-- header -->
    <div class="box-body">
      <form action="<?php echo site_url('admin/DataUser/simpanMasyarakat'); ?>" method="post" enctype="multipart/form-data">
