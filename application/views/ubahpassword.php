            ...
            <form action="<?php echo base_url('home/ubahpassword'); ?>" method="post">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <?php echo form_error('password', '<small class="text-blue pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        ...
                        <?php echo form_error('new_password1', '<small class="text-blue pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        ...
                        <?php echo form_error('new_password2', '<small class="text-blue pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
